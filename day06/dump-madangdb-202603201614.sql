...
INSERT INTO `Book` VALUES (1,'축구의 역사','굿스포츠',7000),(2,'축구 아는 여자','나무수',13000),(3,'축구의 이해','대한미디어',22000),(4,'골프 바이블','대한미디어',35000),(5,'피겨 교본','굿스포츠',8000),(6,'배구 단계별기술','굿스포츠',6000),(7,'야구의 추억','이상미디어',20000),(8,'야구를 부탁해','이상미디어',13000),(9,'올림픽 이야기','삼성당',7500),(10,'Olympic Champions','Pearson',13000),(11,'스포츠의학','한솔의학서적',90000),(12,'스포츠의학2','한솔의학서적',NULL),(14,'스포츠의학3','Pearson',NULL),(21,'Zen Golf','Pearson',12000),(22,'Soccer Skills','Human Kinetics',15000),(31,'살면서 한번은 벽돌','글항아리',19500),(32,'100년 쓰는 완벽 허리','한즈미디어',19800),(33,'60일 영어 습관','시원스쿨닷컴',18900),(40,'에이리언 어스','20세기미디어',20000);
...
INSERT INTO `Book_copy` VALUES (1,'축구의 역사','굿스포츠',7000),(2,'축구 아는 여자','나무수',13000),(3,'축구의 이해','대한미디어',22000),(4,'골프 바이블','대한미디어',35000),(5,'피겨 교본','굿스포츠',8000);
...
--
-- Dumping data for table `Customer_copy`
--

LOCK TABLES `Customer_copy` WRITE;
/*!40000 ALTER TABLE `Customer_copy` DISABLE KEYS */;
INSERT INTO `Customer_copy` VALUES (1,'박지성','영국 맨체스타','000-5000-0001'),(2,'김연아','대한민국 서울','000-6000-0001'),(3,'김연경','대한민국 경기도','000-7000-0001'),(4,'추신수','미국 클리블랜드','000-8000-0001'),(5,'박세리','대한민국 대전',NULL);
/*!40000 ALTER TABLE `Customer_copy` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `NewBook` (
  ...
  CONSTRAINT `NewBook_chk_1` CHECK ((`price` > 1000))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `NewBook` VALUES (1,'야구의 추억','대한미디어',9000.00),(2,'골프 바이블','이상미디어',10000.00),(3,'골프여제 박세리','피어슨',1001.00);
...
INSERT INTO `Noidx_Book` VALUES (1,'프로젝트 헤일메리','미디어','9789111111111',2022,18000);
...
INSERT INTO `accounts` VALUES (1,'Kim',30000),(2,'Lee',7000),(3,'Sung',9996500);
...
INSERT INTO `employees` VALUES (1,'Ashely',3000),(2,'Bread',4000),(3,'Canton',6000);
...
-- Dump completed on 2026-03-20 16:14:48
